    ...
    return (
        <div id="container">
            ...
            <div id="control">
                ...
                <button className="btn btn-outline-primary" onClick={() => changeBallImage('/public/basketball.jpg')}>Basketball</button>
                <button className="btn btn-outline-primary" onClick={() => changeBallImage('/public/football.jpg')}>Football</button>
                <button className="btn btn-outline-primary" onClick={() => changeBallImage('/public/volleyball.jpg')}>Voleyball</button>
                <button className="btn btn-outline-primary" onClick={() => changeBallImage('/public/human.jpg')}>Human</button>
                <button className="btn btn-outline-primary" onClick={() => changeBallImage('/public/cartoon.png')}>Cartoon</button>
            </div>
